...
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		...
		Alloc: map[common.Address]GenesisAccount{
			params.GenesisAccountMainnet:   {Balance: new(big.Int).Mul(big.NewInt(10000000000), big.NewInt(1e18))},
...
func DefaultTestnetGenesisBlock() *Genesis {
	return &Genesis{
		...
		Alloc: map[common.Address]GenesisAccount{
			params.GenesisAccountTestnet:   {Balance: new(big.Int).Mul(big.NewInt(65000000), big.NewInt(1e18))},
